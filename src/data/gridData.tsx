...
function renderSparklineCell(params: GridCellParams<number[], unknown>) {
...
export function renderAvatar(
  ...
  if (
    ...
    typeof (params.value as { color: string }).color !== 'string'
  ) {
    return '';
  }
  ...
  return (
    ...
    >
      {typeof (params.value as { name: string }).name === 'string'
